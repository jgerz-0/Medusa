...
## Compose Manifests
- `infra/docker/docker-compose.yml` – boots Postgres, Redis, MinIO, Qdrant, the FastAPI controller, the nuclei, ZAP, SQLMap, and CVE enrichment workers, plus the Next.js frontend.
